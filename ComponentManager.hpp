...
namespace ft
{
  ...
  {
     using component_map = std::unordered_map<uint64_t,std::vector<ft::Components::BaseComponent*>*>;
  public:
     ...
     {
        std::vector<ft::Components::BaseComponent*>* container = map[Type::value<T>()];
        if(container == nullptr)
        {
           map[Type::value<T>()] = new std::vector<ft::Components::BaseComponent*>();
        }
     ...
     bool HasComponent(uint64_t entity)
     {
        ...
        auto it = std::find_if(container->begin(),container->end(),
                               [&] (const ft::Components::BaseComponent* component)
        {
